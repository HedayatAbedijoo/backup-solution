...
test('create credential', async t => {
  await runScenario(async scenario => {
    ...
    if (!alice_dna_ssi_cell) throw new Error("No cell for role id dna_ssi was found");

    const bob_dna_ssi_cell = bob.cells.find(c => c.role_id === 'dna_ssi');
    if (!bob_dna_ssi_cell) throw new Error("No cell for role id dna_ssi was found");
    


    const createInput = {
  value: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed nec eros quis enim hendrerit aliquet.'
};
