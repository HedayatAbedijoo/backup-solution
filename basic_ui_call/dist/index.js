...
/***/ "./node_modules/@holochain/client/node_modules/isomorphic-ws/browser.js":
/*!******************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/isomorphic-ws/browser.js ***!
  \******************************************************************************/
...
/***/ "./node_modules/@holochain/client/lib/api/admin/index.js":
/*!***************************************************************!*\
  !*** ./node_modules/@holochain/client/lib/api/admin/index.js ***!
  \***************************************************************/
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AdminWebsocket": () => (/* reexport safe */ _websocket_js__WEBPACK_IMPORTED_MODULE_1__.AdminWebsocket),
/* harmony export */   "AppStatusFilter": () => (/* reexport safe */ _types_js__WEBPACK_IMPORTED_MODULE_0__.AppStatusFilter)
/* harmony export */ });
/* harmony import */ var _types_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types.js */ "./node_modules/@holochain/client/lib/api/admin/types.js");
/* harmony import */ var _websocket_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./websocket.js */ "./node_modules/@holochain/client/lib/api/admin/websocket.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AppStatusFilter": () => (/* binding */ AppStatusFilter)
/* harmony export */ });
var AppStatusFilter;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AdminWebsocket": () => (/* binding */ AdminWebsocket)
/* harmony export */ });
/* harmony import */ var _types_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types.js */ "./node_modules/@holochain/client/lib/api/admin/types.js");
/* harmony import */ var _client_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../client.js */ "./node_modules/@holochain/client/lib/api/client.js");
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common.js */ "./node_modules/@holochain/client/lib/api/common.js");
/* harmony import */ var _environments_launcher_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../environments/launcher.js */ "./node_modules/@holochain/client/lib/environments/launcher.js");
/**
...
class AdminWebsocket {
    ...
    constructor(client, defaultTimeout) {
        this.client = client;
        this.defaultTimeout =
            defaultTimeout === undefined ? _common_js__WEBPACK_IMPORTED_MODULE_2__.DEFAULT_TIMEOUT : defaultTimeout;
    }
    static async connect(url, defaultTimeout) {
        // Check if we are in the launcher's environment, and if so, redirect the url to connect to
        const env = await (0,_environments_launcher_js__WEBPACK_IMPORTED_MODULE_3__.getLauncherEnvironment)();
        if (env) {
            url = `ws://localhost:${env.ADMIN_INTERFACE_PORT}`;
        }
        const wsClient = await _client_js__WEBPACK_IMPORTED_MODULE_1__.WsClient.connect(url);
        return new AdminWebsocket(wsClient, defaultTimeout);
    }
    _requester = (tag, transformer) => (0,_common_js__WEBPACK_IMPORTED_MODULE_2__.requesterTransformer)((req, timeout) => (0,_common_js__WEBPACK_IMPORTED_MODULE_2__.promiseTimeout)(this.client.request(req), tag, timeout || this.defaultTimeout).then(_common_js__WEBPACK_IMPORTED_MODULE_2__.catchError), tag, transformer);
...
function getAppStatusInApiForm(status_filter) {
    switch (status_filter) {
        case _types_js__WEBPACK_IMPORTED_MODULE_0__.AppStatusFilter.Running:
            return {
                Running: null,
            };
        case _types_js__WEBPACK_IMPORTED_MODULE_0__.AppStatusFilter.Enabled:
            return {
                Enabled: null,
            };
        case _types_js__WEBPACK_IMPORTED_MODULE_0__.AppStatusFilter.Paused:
            return {
                Paused: null,
            };
        case _types_js__WEBPACK_IMPORTED_MODULE_0__.AppStatusFilter.Disabled:
            return {
                Disabled: null,
            };
        case _types_js__WEBPACK_IMPORTED_MODULE_0__.AppStatusFilter.Stopped:
            return {
                Stopped: null,
            };
    }
...
/***/ "./node_modules/@holochain/client/lib/api/app/index.js":
/*!*************************************************************!*\
  !*** ./node_modules/@holochain/client/lib/api/app/index.js ***!
  \*************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AppWebsocket": () => (/* reexport safe */ _websocket_js__WEBPACK_IMPORTED_MODULE_1__.AppWebsocket)
/* harmony export */ });
/* harmony import */ var _types_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./types.js */ "./node_modules/@holochain/client/lib/api/app/types.js");
/* harmony import */ var _websocket_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./websocket.js */ "./node_modules/@holochain/client/lib/api/app/websocket.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AppWebsocket": () => (/* binding */ AppWebsocket)
/* harmony export */ });
/* harmony import */ var _msgpack_msgpack__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @msgpack/msgpack */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/encode.mjs");
/* harmony import */ var _msgpack_msgpack__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @msgpack/msgpack */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/decode.mjs");
/* harmony import */ var _environments_launcher_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../environments/launcher.js */ "./node_modules/@holochain/client/lib/environments/launcher.js");
/* harmony import */ var _client_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../client.js */ "./node_modules/@holochain/client/lib/api/client.js");
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common.js */ "./node_modules/@holochain/client/lib/api/common.js");
/**
...
class AppWebsocket {
    ...
    static async connect(url, defaultTimeout, signalCb) {
        // Check if we are in the launcher's environment, and if so, redirect the url to connect to
        const env = await (0,_environments_launcher_js__WEBPACK_IMPORTED_MODULE_0__.getLauncherEnvironment)();
        if (env) {
            url = `ws://localhost:${env.APP_INTERFACE_PORT}`;
        }
        const wsClient = await _client_js__WEBPACK_IMPORTED_MODULE_1__.WsClient.connect(url, signalCb);
...
const callZomeTransform = {
    input: (req) => {
        return {
            ...req,
            payload: (0,_msgpack_msgpack__WEBPACK_IMPORTED_MODULE_3__.encode)(req.payload),
        };
    },
    output: (res) => {
        return (0,_msgpack_msgpack__WEBPACK_IMPORTED_MODULE_4__.decode)(res);
    },
};
...
/* harmony export */ });
/* harmony import */ var _msgpack_msgpack__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @msgpack/msgpack */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/decode.mjs");
/* harmony import */ var _msgpack_msgpack__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @msgpack/msgpack */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/encode.mjs");
/* harmony import */ var isomorphic_ws__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! isomorphic-ws */ "./node_modules/@holochain/client/node_modules/isomorphic-ws/browser.js");
...
class WsClient {
    ...
    constructor(socket, signalCb) {
        ...
        socket.onmessage = async (encodedMsg) => {
            ...
            const msg = (0,_msgpack_msgpack__WEBPACK_IMPORTED_MODULE_1__.decode)(data);
            if (msg.type === "Signal") {
                if (signalCb) {
                    const decodedMessage = (0,_msgpack_msgpack__WEBPACK_IMPORTED_MODULE_1__.decode)(msg.data);
    ...
    emitSignal(data) {
        const encodedMsg = (0,_msgpack_msgpack__WEBPACK_IMPORTED_MODULE_2__.encode)({
            type: "Signal",
            data: (0,_msgpack_msgpack__WEBPACK_IMPORTED_MODULE_2__.encode)(data),
        });
    ...
    handleResponse(msg) {
        ...
        if (this.pendingRequests[id]) {
            ...
            if (msg.data === null || msg.data === undefined) {
                ...
                this.pendingRequests[id].fulfill((0,_msgpack_msgpack__WEBPACK_IMPORTED_MODULE_1__.decode)(msg.data));
            }
        }
        else {
    ...
    static connect(url, signalCb) {
        return new Promise((resolve, reject) => {
            const socket = new isomorphic_ws__WEBPACK_IMPORTED_MODULE_0__["default"](url);
...
const signalTransform = (res) => {
    return (0,_msgpack_msgpack__WEBPACK_IMPORTED_MODULE_1__.decode)(res);
};
...
/* harmony export */   "requesterTransformer": () => (/* binding */ requesterTransformer)
/* harmony export */ });
...
/***/ "./node_modules/@holochain/client/lib/api/index.js":
/*!*********************************************************!*\
  !*** ./node_modules/@holochain/client/lib/api/index.js ***!
  \*********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AdminWebsocket": () => (/* reexport safe */ _admin_index_js__WEBPACK_IMPORTED_MODULE_0__.AdminWebsocket),
/* harmony export */   "AppStatusFilter": () => (/* reexport safe */ _admin_index_js__WEBPACK_IMPORTED_MODULE_0__.AppStatusFilter),
/* harmony export */   "AppWebsocket": () => (/* reexport safe */ _app_index_js__WEBPACK_IMPORTED_MODULE_1__.AppWebsocket),
/* harmony export */   "CloneId": () => (/* reexport safe */ _common_js__WEBPACK_IMPORTED_MODULE_2__.CloneId)
/* harmony export */ });
/* harmony import */ var _admin_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./admin/index.js */ "./node_modules/@holochain/client/lib/api/admin/index.js");
/* harmony import */ var _app_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app/index.js */ "./node_modules/@holochain/client/lib/api/app/index.js");
/* harmony import */ var _common_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./common.js */ "./node_modules/@holochain/client/lib/api/common.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LAUNCHER_ENV_URL": () => (/* binding */ LAUNCHER_ENV_URL),
/* harmony export */   "getLauncherEnvironment": () => (/* binding */ getLauncherEnvironment)
/* harmony export */ });
...
async function fetchLauncherEnvironment() {
    const env = await cross_fetch__WEBPACK_IMPORTED_MODULE_0__(LAUNCHER_ENV_URL);
    if (env.ok) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DhtOpType": () => (/* binding */ DhtOpType),
/* harmony export */   "getDhtOpAction": () => (/* binding */ getDhtOpAction),
/* harmony export */   "getDhtOpEntry": () => (/* binding */ getDhtOpEntry),
/* harmony export */   "getDhtOpSignature": () => (/* binding */ getDhtOpSignature),
/* harmony export */   "getDhtOpType": () => (/* binding */ getDhtOpType)
/* harmony export */ });
...
/***/ "./node_modules/@holochain/client/lib/hdk/index.js":
/*!*********************************************************!*\
  !*** ./node_modules/@holochain/client/lib/hdk/index.js ***!
  \*********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ActionType": () => (/* reexport safe */ _action_js__WEBPACK_IMPORTED_MODULE_0__.ActionType),
/* harmony export */   "DhtOpType": () => (/* reexport safe */ _dht_ops_js__WEBPACK_IMPORTED_MODULE_2__.DhtOpType),
/* harmony export */   "getDhtOpAction": () => (/* reexport safe */ _dht_ops_js__WEBPACK_IMPORTED_MODULE_2__.getDhtOpAction),
/* harmony export */   "getDhtOpEntry": () => (/* reexport safe */ _dht_ops_js__WEBPACK_IMPORTED_MODULE_2__.getDhtOpEntry),
/* harmony export */   "getDhtOpSignature": () => (/* reexport safe */ _dht_ops_js__WEBPACK_IMPORTED_MODULE_2__.getDhtOpSignature),
/* harmony export */   "getDhtOpType": () => (/* reexport safe */ _dht_ops_js__WEBPACK_IMPORTED_MODULE_2__.getDhtOpType)
/* harmony export */ });
/* harmony import */ var _action_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./action.js */ "./node_modules/@holochain/client/lib/hdk/action.js");
/* harmony import */ var _capabilities_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./capabilities.js */ "./node_modules/@holochain/client/lib/hdk/capabilities.js");
/* harmony import */ var _dht_ops_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./dht-ops.js */ "./node_modules/@holochain/client/lib/hdk/dht-ops.js");
/* harmony import */ var _entry_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./entry.js */ "./node_modules/@holochain/client/lib/hdk/entry.js");
/* harmony import */ var _record_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./record.js */ "./node_modules/@holochain/client/lib/hdk/record.js");
...
/***/ "./node_modules/@holochain/client/lib/hdk/record.js":
/*!**********************************************************!*\
  !*** ./node_modules/@holochain/client/lib/hdk/record.js ***!
  \**********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@holochain/client/lib/index.js":
/*!*****************************************************!*\
  !*** ./node_modules/@holochain/client/lib/index.js ***!
  \*****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ActionType": () => (/* reexport safe */ _hdk_index_js__WEBPACK_IMPORTED_MODULE_1__.ActionType),
/* harmony export */   "AdminWebsocket": () => (/* reexport safe */ _api_index_js__WEBPACK_IMPORTED_MODULE_0__.AdminWebsocket),
/* harmony export */   "AppStatusFilter": () => (/* reexport safe */ _api_index_js__WEBPACK_IMPORTED_MODULE_0__.AppStatusFilter),
/* harmony export */   "AppWebsocket": () => (/* reexport safe */ _api_index_js__WEBPACK_IMPORTED_MODULE_0__.AppWebsocket),
/* harmony export */   "CloneId": () => (/* reexport safe */ _api_index_js__WEBPACK_IMPORTED_MODULE_0__.CloneId),
/* harmony export */   "DhtOpType": () => (/* reexport safe */ _hdk_index_js__WEBPACK_IMPORTED_MODULE_1__.DhtOpType),
/* harmony export */   "getDhtOpAction": () => (/* reexport safe */ _hdk_index_js__WEBPACK_IMPORTED_MODULE_1__.getDhtOpAction),
/* harmony export */   "getDhtOpEntry": () => (/* reexport safe */ _hdk_index_js__WEBPACK_IMPORTED_MODULE_1__.getDhtOpEntry),
/* harmony export */   "getDhtOpSignature": () => (/* reexport safe */ _hdk_index_js__WEBPACK_IMPORTED_MODULE_1__.getDhtOpSignature),
/* harmony export */   "getDhtOpType": () => (/* reexport safe */ _hdk_index_js__WEBPACK_IMPORTED_MODULE_1__.getDhtOpType)
/* harmony export */ });
/* harmony import */ var _api_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api/index.js */ "./node_modules/@holochain/client/lib/api/index.js");
/* harmony import */ var _hdk_index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hdk/index.js */ "./node_modules/@holochain/client/lib/hdk/index.js");
/* harmony import */ var _types_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./types.js */ "./node_modules/@holochain/client/lib/types.js");
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/CachedKeyDecoder.mjs":
/*!********************************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/CachedKeyDecoder.mjs ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_utf8_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/utf8.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/utf8.mjs");
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/DecodeError.mjs":
/*!***************************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/DecodeError.mjs ***!
  \***************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/Decoder.mjs":
/*!***********************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/Decoder.mjs ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_prettyByte_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/prettyByte.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/prettyByte.mjs");
/* harmony import */ var _ExtensionCodec_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ExtensionCodec.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/ExtensionCodec.mjs");
/* harmony import */ var _utils_int_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/int.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/int.mjs");
/* harmony import */ var _utils_utf8_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/utf8.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/utf8.mjs");
/* harmony import */ var _utils_typedArrays_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/typedArrays.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/typedArrays.mjs");
/* harmony import */ var _CachedKeyDecoder_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CachedKeyDecoder.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/CachedKeyDecoder.mjs");
/* harmony import */ var _DecodeError_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DecodeError.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/DecodeError.mjs");
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/Encoder.mjs":
/*!***********************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/Encoder.mjs ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _utils_utf8_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/utf8.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/utf8.mjs");
/* harmony import */ var _ExtensionCodec_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ExtensionCodec.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/ExtensionCodec.mjs");
/* harmony import */ var _utils_int_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/int.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/int.mjs");
/* harmony import */ var _utils_typedArrays_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/typedArrays.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/typedArrays.mjs");
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/ExtData.mjs":
/*!***********************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/ExtData.mjs ***!
  \***********************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/ExtensionCodec.mjs":
/*!******************************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/ExtensionCodec.mjs ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _ExtData_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ExtData.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/ExtData.mjs");
/* harmony import */ var _timestamp_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timestamp.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/timestamp.mjs");
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/decode.mjs":
/*!**********************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/decode.mjs ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Decoder_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Decoder.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/Decoder.mjs");
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/encode.mjs":
/*!**********************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/encode.mjs ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Encoder_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Encoder.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/Encoder.mjs");
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/timestamp.mjs":
/*!*************************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/timestamp.mjs ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _DecodeError_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DecodeError.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/DecodeError.mjs");
/* harmony import */ var _utils_int_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/int.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/int.mjs");
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/int.mjs":
/*!*************************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/int.mjs ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/prettyByte.mjs":
/*!********************************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/prettyByte.mjs ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/typedArrays.mjs":
/*!*********************************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/typedArrays.mjs ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/utf8.mjs":
/*!**************************************************************************************************!*\
  !*** ./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/utf8.mjs ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _int_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./int.mjs */ "./node_modules/@holochain/client/node_modules/@msgpack/msgpack/dist.es5+esm/utils/int.mjs");
var _a, _b, _c;
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _holochain_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @holochain/client */ "./node_modules/@holochain/client/lib/index.js");
...
class Index {
  ...
  async call_zome_fn(port, appid, fnname, payload = null) {
    ...
    const client = await _holochain_client__WEBPACK_IMPORTED_MODULE_0__.AppWebsocket.connect(
